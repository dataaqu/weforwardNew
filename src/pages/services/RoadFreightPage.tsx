          ...
          <div className="space-y-8 flex flex-col justify-center">
            ...
            <div className={`p-8 rounded-lg border ${
              ...
              <h3 lang={language} className={`text-3xl font-bold mb-6 ${
                ...
                {t.roadFreight.fullTrailer.title}
              </h3>
              <div className="space-y-3 text-left">
                <div className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'} grid grid-cols-2 gap-3`}>
            ...
            <div className={`p-8 rounded-lg border ${
              ...
              <h3 lang={language} className={`text-3xl font-bold mb-6 ${
                ...
                {t.roadFreight.groupage.title}
              </h3>
              <div className="space-y-3 text-left">
                <div className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'} space-y-2`}>
                  {t.roadFreight.groupage.description.split('\n').map((line, index) => (
